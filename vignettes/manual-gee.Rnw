...
\SweaveOpts{prefix.string=manual-gee}
...
\subsection*{How To Cite the \emph{gamma.gee} Zelig model}
\begin{verse}
...
\subsection*{How To Cite the \emph{logit.gee} Zelig Model}
\begin{verse}
...
\subsection*{How To Cite the \emph{normal.gee} Zelig model}
\begin{verse}
...
\subsection*{How To Cite \emph{poisson.gee} Zelig model}
\begin{verse}
...
\subsection*{How To Cite \emph{probit.gee} Zelig model}
\begin{verse}

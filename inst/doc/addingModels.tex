...
\subsubsubsection{Return Values of a \emph{zelig2} Function}
...
\subsubsubsection{Example Code for Simple Vector/Matrix Method}
\begin{verbatim}
...
\subsubsubsection{Example of Indexed List Method with \emph{fam} Object Set}
...
\subsubsubsection{Explanation of Indexed List with \emph{fam} Object Set Example}
...
% ANOTHER METHOD
\subsubsubsection{Example of Indexed List Method (with \emph{link} Function) Set}
...
\subsubsubsection{Explanation of Indexed List (with \emph{link} Function) Example}

...
#' Zelig
#' @usage simulations.plot(y, y1=NULL, xlab="", ylab="", main="", col=NULL, bg=NULL, axisnames=TRUE)
#' @S3method plot zelig
...
#' built for main plot objects.
#' @param line.col  A vector of colors.  Colors will be used in turn as the graph is
#' built for backgrounds and shading of plot objects.  These colors should
#' generally be partially transparent.
#' @param axisname a character-vector, specifying the names of the axes
#' @return nothing

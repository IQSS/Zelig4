...
#'
#' This method exists solely as a backup when an author does not
#' contribute a `describe' function for their model
#'
#' @param ... dummy parameters purely to cast the correct object.
#'            That is, the parameters of the function should not
